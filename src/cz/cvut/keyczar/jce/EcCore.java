...
public final class EcCore extends Provider {
  ...
  public EcCore() {
    ...
    AccessController.doPrivileged(new java.security.PrivilegedAction() {
      public Object run() {
        put("Signature.SHA1withECDSA", "cz.cvut.jce.EcSignatureImpl$SHA1");
        put("Alg.Alias.Signature.ECDSA", "SHA1withDSA");
        put("Signature.SHA256withECDSA",
            "cz.cvut.keyczar.jce.EcSignatureImpl$SHA256");
        put("Signature.SHA384withECDSA",
            "cz.cvut.keyczar.jce.EcSignatureImpl$SHA384");
        put("Signature.SHA512withECDSA",
            "cz.cvut.keyczar.jce.EcSignatureImpl$SHA512");
        put("KeyPairGenerator.EC", "cz.cvut.keyczar.jce.EcKeyPairGeneratorImpl");
        put("KeyFactory.EC", "cz.cvut.keyczar.jce.EcKeyFactoryImpl");
